...
- name: Dezrez.Rezi.Client.Api - Confirms the compliance checks have been carried
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/confirm/master/_listings/dezrez/apiroleidconfirmcompliancechecks-put-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/confirm/master/_listings/dezrez/apiroleidconfirmcompliancechecks-put-openapi.md
x-common:
- type: x-github
